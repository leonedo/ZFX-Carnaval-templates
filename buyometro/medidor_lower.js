...
// --- container visibility animation helpers ---
function showBM() {
    animContainer.classList.remove('exit');
    animContainer.classList.remove('enter');
    void animContainer.offsetWidth; // restart CSS animation
    animContainer.classList.add('enter');
}

function hideBM() {
    animContainer.classList.remove('enter');
    animContainer.classList.add('exit');
}
...
let anim = loadAnimation(jsonfile, animContainer)
let externalLoop;
